...
/***/ function(module, exports, __webpack_require__) {
	...
	$.ajax({
	  ...
	  success: function success(data) {
	    ...
	    React.render(React.createElement(Fact, props), document.getElementById('bouncer5'));
	  }
	});
	...
	$.ajax({
	  ...
	  success: function success(data) {
	    ...
	    React.render(React.createElement(Fact, props), document.getElementById('bouncer6'));
	  }
	});
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                null,
	                React.createElement("img", { src: this.props.fact.image, height: "85%", width: "100px" })
	            ),
	            React.createElement(
	                "div",
	                null,
