...
/***/ function(module, exports, __webpack_require__) {
	...
	$.ajax({
	  ...
	  success: function success(data) {
	    ...
	    React.render(React.createElement(Fact, props), document.getElementById('content'));
	  }
	});
	...
	$.ajax({
	  ...
	  success: function success(data) {
	    ...
	    React.render(React.createElement(Fact, props), document.getElementById('content2'));
	  }
	});
